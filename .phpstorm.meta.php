...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'blog.name' => 'string',
            'blog.credits.company' => 'string',
            'blog.credits.email' => 'string',
            'blog.credits.address' => 'string',
            'blog.social.github' => 'string',
            'blog.social.linkedin' => 'string',
            'blog.social.x' => 'string',
            ...
            'filesystems.links.C:\Users\DanieleMontecchi\Code\dm.blog\public\storage' => 'string',
...
'auth.passwords.users.throttle','auth.password_timeout','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
'blade-heroicons.attributes','blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback',
'blade-icons.components.disabled','blade-icons.components.default','blade-ui-kit.components.alert','blade-ui-kit.components.avatar','blade-ui-kit.components.carbon',
'blade-ui-kit.components.checkbox','blade-ui-kit.components.color-picker','blade-ui-kit.components.countdown','blade-ui-kit.components.cron','blade-ui-kit.components.dropdown',
'blade-ui-kit.components.easy-mde','blade-ui-kit.components.email','blade-ui-kit.components.error','blade-ui-kit.components.flat-pickr','blade-ui-kit.components.form',
'blade-ui-kit.components.form-button','blade-ui-kit.components.html','blade-ui-kit.components.input','blade-ui-kit.components.label','blade-ui-kit.components.logout',
'blade-ui-kit.components.mapbox','blade-ui-kit.components.markdown','blade-ui-kit.components.password','blade-ui-kit.components.pikaday','blade-ui-kit.components.social-meta',
'blade-ui-kit.components.textarea','blade-ui-kit.components.toc','blade-ui-kit.components.trix','blade-ui-kit.components.unsplash','blade-ui-kit.livewire',
'blade-ui-kit.prefix','blade-ui-kit.assets.alpine','blade-ui-kit.assets.easy-mde','blade-ui-kit.assets.flat-pickr','blade-ui-kit.assets.mapbox',
'blade-ui-kit.assets.moment','blade-ui-kit.assets.pickr','blade-ui-kit.assets.pikaday','blade-ui-kit.assets.trix','blog.name',
'blog.credits.company','blog.credits.email','blog.credits.address','blog.social.github','blog.social.linkedin',
'blog.social.x','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.blog.driver','filesystems.disks.blog.root','filesystems.disks.blog.url',
'filesystems.disks.blog.visibility','filesystems.links.C:\\Users\\DanieleMontecchi\\Code\\dm.blog\\public\\storage','log-viewer.enabled','log-viewer.api_only','log-viewer.require_auth_in_production',
...
'sentry.tracing.missing_routes','sentry.tracing.continue_after_response','sentry.tracing.default_integrations','seotools.meta.defaults.title','seotools.meta.defaults.titleBefore',
...
'seotools.opengraph.defaults.type','seotools.opengraph.defaults.site_name','seotools.opengraph.defaults.images','seotools.twitter.defaults','seotools.json-ld.defaults.title',
'seotools.json-ld.defaults.description','seotools.json-ld.defaults.url','seotools.json-ld.defaults.type','seotools.json-ld.defaults.images','services.postmark.token',
...
'services.slack.notifications.channel','services.google.analytics_tracking_id','services.google.analytics_property_id','services.google.analytics_service_account_credentials','session.driver',
...
'settings.cache.prefix','settings.cache.ttl','settings.global_casts.DateTimeInterface','settings.global_casts.DateTimeZone','settings.auto_discover_settings',
'settings.discovered_settings_cache_path','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'filament.admin.pages.dashboard','filament.admin.pages.settings.general','filament.admin.pages.settings.links','filament.admin.pages.settings.marketing','filament.admin.pages.settings.seo',
'filament.admin.pages.settings.services','filament.admin.resources.blog-categories.index','filament.admin.resources.blog-categories.create','filament.admin.resources.blog-categories.edit','filament.admin.resources.blog-posts.index',
'filament.admin.resources.blog-posts.create','filament.admin.resources.blog-posts.edit','filament.admin.resources.blog-tags.index','filament.admin.resources.blog-tags.create','filament.admin.resources.blog-tags.edit',
'filament.admin.resources.pages.index','filament.admin.resources.pages.create','filament.admin.resources.pages.edit','livewire.update','livewire.upload-file','livewire.preview-file','log-viewer.hosts','log-viewer.folders',
...
'log-viewer.folders.download','log-viewer.files.download','log-viewer.index','laravel-folio',
'blog.index','blog.show','blog.category','storage.local',);
        registerArgumentsSet('views', 
'blog.index','blog.show','components.avatar-card','components.blog-post-card','components.breadcrumbs',
'components.layouts.app','components.layouts.partials.cookie','components.layouts.partials.footer','components.layouts.partials.header','components.layouts.partials.metatag',
'errors.404','errors.500','filament.widgets.google-analytics-visitors-widget','livewire.search-modal','pages.index',
'pages.index.about','pages.index.blog','pages.index.features','pages.privacy','pages.terms',
'pagination::tailwindui','vendor.pagination.tailwindui','blade-ui-kit::components.alerts.alert','blade-ui-kit::components.buttons.form-button','blade-ui-kit::components.buttons.logout',
'blade-ui-kit::components.date-time.carbon','blade-ui-kit::components.date-time.countdown','blade-ui-kit::components.editors.easy-mde','blade-ui-kit::components.editors.trix','blade-ui-kit::components.forms.error',
'blade-ui-kit::components.forms.form','blade-ui-kit::components.forms.inputs.checkbox','blade-ui-kit::components.forms.inputs.color-picker','blade-ui-kit::components.forms.inputs.email','blade-ui-kit::components.forms.inputs.flat-pickr',
'blade-ui-kit::components.forms.inputs.input','blade-ui-kit::components.forms.inputs.password','blade-ui-kit::components.forms.inputs.pikaday','blade-ui-kit::components.forms.inputs.textarea','blade-ui-kit::components.forms.label',
'blade-ui-kit::components.layouts.html','blade-ui-kit::components.layouts.social-meta','blade-ui-kit::components.maps.mapbox','blade-ui-kit::components.markdown.markdown','blade-ui-kit::components.markdown.toc',
'blade-ui-kit::components.navigation.dropdown','blade-ui-kit::components.support.avatar','blade-ui-kit::components.support.cron','blade-ui-kit::components.support.unsplash','filament-actions::badge-action',
...
'filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-spatie-laravel-settings-plugin::pages.settings-page','filament-tables::columns.checkbox-column',
...
'filament-notifications::database.modal.actions.clear.label','filament-notifications::database.modal.actions.mark_all_as_read.label','filament-notifications::database.modal.empty.heading','filament-notifications::database.modal.empty.description','filament-spatie-laravel-settings-plugin::settings-page.0',
