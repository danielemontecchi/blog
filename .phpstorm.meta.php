...
namespace PHPSTORM_META {
	...
	*/
	...
	override(\config(), map([
		...
		'analytics.service_account_credentials_json'                   => 'NULL',
		...
		'blade-ui-kit.assets.easy-mde'                                 => 'string',
		'blade-ui-kit.assets.flat-pickr'                               => 'string',
		'blade-ui-kit.assets.mapbox'                                   => 'string',
		'blade-ui-kit.assets.moment'                                   => 'string',
		'blade-ui-kit.assets.pickr'                                    => 'string',
		'blade-ui-kit.assets.pikaday'                                  => 'string',
		'blade-ui-kit.assets.trix'                                     => 'string',
		...
		'filesystems.disks.blog.visibility'                            => 'string',
		'filesystems.disks.blog.throw'                                 => 'boolean',
		'filesystems.links./Users/lele/Code/dm.site/public/storage'    => 'string',
		'horizon.domain'                                               => 'NULL',
		'horizon.path'                                                 => 'string',
		'horizon.use'                                                  => 'string',
		...
		'sentry.ignore_transactions'                                   => 'string',
		...
		'services.google.analytics_tracking_id'                        => 'NULL',
		'services.google.analytics_property_id'                        => 'NULL',
		'services.google.analytics_service_account_credentials'        => 'NULL',
		...
		'site.name'                                                    => 'string',
		'site.credits.company'                                         => 'string',
		'site.social.github'                                           => 'string',
		'site.social.linkedin'                                         => 'string',
		'site.social.x'                                                => 'string',
	...
	registerArgumentsSet(
		...
		'analytics.cache_lifetime_in_minutes',
		...
		'blade-heroicons.prefix',
		'blade-heroicons.fallback',
		'blade-heroicons.class',
		'blade-heroicons.attributes',
		'blade-icons.sets',
		'blade-icons.class',
		'blade-icons.attributes',
		'blade-icons.fallback',
		'blade-icons.components.disabled',
		'blade-icons.components.default',
		'blade-ui-kit.components.alert',
		'blade-ui-kit.components.avatar',
		'blade-ui-kit.components.carbon',
		'blade-ui-kit.components.checkbox',
		'blade-ui-kit.components.color-picker',
		'blade-ui-kit.components.countdown',
		'blade-ui-kit.components.cron',
		'blade-ui-kit.components.dropdown',
		'blade-ui-kit.components.easy-mde',
		'blade-ui-kit.components.email',
		'blade-ui-kit.components.error',
		'blade-ui-kit.components.flat-pickr',
		'blade-ui-kit.components.form',
		'blade-ui-kit.components.form-button',
		'blade-ui-kit.components.html',
		'blade-ui-kit.components.input',
		'blade-ui-kit.components.label',
		'blade-ui-kit.components.logout',
		'blade-ui-kit.components.mapbox',
		'blade-ui-kit.components.markdown',
		'blade-ui-kit.components.password',
		'blade-ui-kit.components.pikaday',
		'blade-ui-kit.components.social-meta',
		'blade-ui-kit.components.textarea',
		'blade-ui-kit.components.toc',
		'blade-ui-kit.components.trix',
		'blade-ui-kit.components.unsplash',
		'blade-ui-kit.livewire',
		'blade-ui-kit.prefix',
		'blade-ui-kit.assets.alpine',
		'blade-ui-kit.assets.easy-mde',
		'blade-ui-kit.assets.flat-pickr',
		'blade-ui-kit.assets.mapbox',
		'blade-ui-kit.assets.moment',
		'blade-ui-kit.assets.pickr',
		'blade-ui-kit.assets.pikaday',
		'blade-ui-kit.assets.trix',
		'cache.default',
		...
		'filesystems.disks.blog.driver',
		'filesystems.disks.blog.root',
		'filesystems.disks.blog.url',
		'filesystems.disks.blog.visibility',
		'filesystems.disks.blog.throw',
		'filesystems.links./Users/lele/Code/dm.site/public/storage',
		'horizon.domain',
		'horizon.path',
		'horizon.use',
		'horizon.prefix',
		...
		'log-viewer.enabled',
		'log-viewer.api_only',
		'log-viewer.require_auth_in_production',
		'log-viewer.route_domain',
		'log-viewer.route_path',
		'log-viewer.back_to_system_url',
		'log-viewer.back_to_system_label',
		'log-viewer.timezone',
		'log-viewer.middleware',
		'log-viewer.api_middleware',
		'log-viewer.api_stateful_domains',
		'log-viewer.hosts.local.name',
		'log-viewer.include_files',
		'log-viewer.exclude_files',
		'log-viewer.hide_unknown_files',
		'log-viewer.shorter_stack_trace_excludes',
		'log-viewer.cache_driver',
		'log-viewer.cache_key_prefix',
		'log-viewer.lazy_scan_chunk_size_in_mb',
		'log-viewer.strip_extracted_context',
		'logging.default',
		...
		'sentry.ignore_transactions',
		'sentry.breadcrumbs.logs',
		'sentry.breadcrumbs.cache',
		'sentry.breadcrumbs.livewire',
		'sentry.breadcrumbs.sql_queries',
		'sentry.breadcrumbs.sql_bindings',
		'sentry.breadcrumbs.queue_info',
		'sentry.breadcrumbs.command_info',
		'sentry.breadcrumbs.http_client_requests',
		'sentry.breadcrumbs.notifications',
		'sentry.tracing.queue_job_transactions',
		'sentry.tracing.queue_jobs',
		'sentry.tracing.sql_queries',
		'sentry.tracing.sql_bindings',
		'sentry.tracing.sql_origin',
		'sentry.tracing.sql_origin_threshold_ms',
		'sentry.tracing.views',
		'sentry.tracing.livewire',
		'sentry.tracing.http_client_requests',
		'sentry.tracing.cache',
		'sentry.tracing.redis_commands',
		'sentry.tracing.redis_origin',
		'sentry.tracing.notifications',
		'sentry.tracing.missing_routes',
		'sentry.tracing.continue_after_response',
		'sentry.tracing.default_integrations',
		'seotools.meta.defaults.title',
		'seotools.meta.defaults.titleBefore',
		'seotools.meta.defaults.description',
		'seotools.meta.defaults.separator',
		'seotools.meta.defaults.keywords',
		'seotools.meta.defaults.canonical',
		'seotools.meta.defaults.robots',
		'seotools.meta.webmaster_tags.google',
		'seotools.meta.webmaster_tags.bing',
		'seotools.meta.webmaster_tags.alexa',
		'seotools.meta.webmaster_tags.pinterest',
		'seotools.meta.webmaster_tags.yandex',
		'seotools.meta.webmaster_tags.norton',
		'seotools.meta.add_notranslate_class',
		'seotools.opengraph.defaults.title',
		'seotools.opengraph.defaults.description',
		'seotools.opengraph.defaults.url',
		'seotools.opengraph.defaults.type',
		'seotools.opengraph.defaults.site_name',
		'seotools.opengraph.defaults.images',
		'seotools.twitter.defaults',
		'seotools.json-ld.defaults.title',
		'seotools.json-ld.defaults.description',
		'seotools.json-ld.defaults.url',
		'seotools.json-ld.defaults.type',
		'seotools.json-ld.defaults.images',
		...
		'services.google.analytics_tracking_id',
		'services.google.analytics_property_id',
		'services.google.analytics_service_account_credentials',
		'session.driver',
		'session.lifetime',
		...
		'session.partitioned',
		'settings.settings',
		'settings.setting_class_path',
		'settings.migrations_paths',
		'settings.default_repository',
		'settings.repositories.database.type',
		'settings.repositories.database.model',
		'settings.repositories.database.table',
		'settings.repositories.database.connection',
		'settings.repositories.redis.type',
		'settings.repositories.redis.connection',
		'settings.repositories.redis.prefix',
		'settings.encoder',
		'settings.decoder',
		...
		'settings.cache.ttl',
		'settings.global_casts.DateTimeInterface',
		'settings.global_casts.DateTimeZone',
		'settings.auto_discover_settings',
		'settings.discovered_settings_cache_path',
		'site.name',
		'site.credits.company',
		'site.social.github',
		...
		'filament.broadcasting',
		'filament.default_filesystem_disk',
		'filament.assets_path',
		'filament.cache_path',
		'filament.livewire_loading_delay',
		'livewire.class_namespace',
		'livewire.view_path',
		'livewire.layout',
		'livewire.lazy_placeholder',
		'livewire.temporary_file_upload.disk',
		...
		'livewire.render_on_redirect',
		'livewire.legacy_model_binding',
		'livewire.inject_assets',
		'livewire.navigate.show_progress_bar',
		'livewire.navigate.progress_bar_color',
		'livewire.inject_morph_markers',
		'livewire.pagination_theme',
		'ide-helper.filename',
	...
	registerArgumentsSet(
		...
		'filament.admin.pages.settings.links',
		'filament.admin.pages.settings.marketing',
		'filament.admin.pages.settings.seo',
		'filament.admin.pages.settings.services',
		...
		'filament.admin.resources.blog-tags.index',
		'filament.admin.resources.blog-tags.create',
		'filament.admin.resources.blog-tags.edit',
	...
	registerArgumentsSet(
		...
		'components.layouts.partials.cookie',
		'components.layouts.partials.footer',
		'components.layouts.partials.header',
		'components.layouts.partials.metatag',
		'errors.404',
		'errors.500',
		'filament.widgets.google-analytics-visitors-widget',
		...
		'pages.home.features',
		'pages.page',
		'pagination::tailwindui',
		'vendor.pagination.tailwindui',
		'blade-ui-kit::components.alerts.alert',
		'blade-ui-kit::components.buttons.form-button',
		'blade-ui-kit::components.buttons.logout',
		'blade-ui-kit::components.date-time.carbon',
		'blade-ui-kit::components.date-time.countdown',
		'blade-ui-kit::components.editors.easy-mde',
		'blade-ui-kit::components.editors.trix',
		'blade-ui-kit::components.forms.error',
		'blade-ui-kit::components.forms.form',
		'blade-ui-kit::components.forms.inputs.checkbox',
		'blade-ui-kit::components.forms.inputs.color-picker',
		'blade-ui-kit::components.forms.inputs.email',
		'blade-ui-kit::components.forms.inputs.flat-pickr',
		'blade-ui-kit::components.forms.inputs.input',
		'blade-ui-kit::components.forms.inputs.password',
		'blade-ui-kit::components.forms.inputs.pikaday',
		'blade-ui-kit::components.forms.inputs.textarea',
		'blade-ui-kit::components.forms.label',
		'blade-ui-kit::components.layouts.html',
		'blade-ui-kit::components.layouts.social-meta',
		'blade-ui-kit::components.maps.mapbox',
		'blade-ui-kit::components.markdown.markdown',
		'blade-ui-kit::components.markdown.toc',
		'blade-ui-kit::components.navigation.dropdown',
		'blade-ui-kit::components.support.avatar',
		'blade-ui-kit::components.support.cron',
		'blade-ui-kit::components.support.unsplash',
		'filament-actions::badge-action',
		'filament-actions::badge-group',
		'filament-actions::button-action',
		'filament-actions::button-group',
		'filament-actions::components.action',
		'filament-actions::components.actions',
		'filament-actions::components.group',
		'filament-actions::components.modals',
		'filament-actions::grouped-action',
		'filament-actions::grouped-group',
		'filament-actions::icon-button-action',
		'filament-actions::icon-button-group',
		'filament-actions::link-action',
		'filament-actions::link-group',
		'filament-actions::select-action',
		'filament-forms::component-container',
		'filament-forms::components.actions',
		'filament-forms::components.actions.action-container',
		'filament-forms::components.builder',
		'filament-forms::components.builder.block-picker',
		'filament-forms::components.checkbox',
		'filament-forms::components.checkbox-list',
		'filament-forms::components.color-picker',
		'filament-forms::components.date-time-picker',
		'filament-forms::components.field-wrapper.error-message',
		'filament-forms::components.field-wrapper.helper-text',
		'filament-forms::components.field-wrapper.hint',
		'filament-forms::components.field-wrapper.index',
		'filament-forms::components.field-wrapper.label',
		...
		'filament-forms::components.key-value',
		'filament-forms::components.livewire',
		'filament-forms::components.markdown-editor',
		'filament-forms::components.placeholder',
		'filament-forms::components.radio',
		'filament-forms::components.repeater.index',
		'filament-forms::components.repeater.simple',
		'filament-forms::components.rich-editor',
		'filament-forms::components.rich-editor.toolbar.button',
		'filament-forms::components.rich-editor.toolbar.group',
		'filament-forms::components.section',
		'filament-forms::components.select',
		'filament-forms::components.split',
		'filament-forms::components.tabs',
		'filament-forms::components.tabs.tab',
		'filament-forms::components.tags-input',
		'filament-forms::components.text-input',
		'filament-forms::components.textarea',
		'filament-forms::components.toggle',
		'filament-forms::components.toggle-buttons.grouped',
		'filament-forms::components.toggle-buttons.index',
		'filament-forms::components.wizard',
		'filament-forms::components.wizard.step',
		'filament-infolists::component-container',
		'filament-infolists::components.actions',
		'filament-infolists::components.actions.action-container',
		'filament-infolists::components.affixes',
		'filament-infolists::components.color-entry',
		'filament-infolists::components.entries.placeholder',
		'filament-infolists::components.entry-wrapper.helper-text',
		'filament-infolists::components.entry-wrapper.hint',
		'filament-infolists::components.entry-wrapper.index',
		'filament-infolists::components.entry-wrapper.label',
		'filament-infolists::components.fieldset',
		'filament-infolists::components.grid',
		'filament-infolists::components.group',
		'filament-infolists::components.icon-entry',
		'filament-infolists::components.image-entry',
		'filament-infolists::components.key-value-entry',
		'filament-infolists::components.livewire',
		'filament-infolists::components.repeatable-entry',
		'filament-infolists::components.section',
		'filament-infolists::components.split',
		'filament-infolists::components.tabs',
		'filament-infolists::components.tabs.tab',
		'filament-infolists::components.text-entry',
		'filament-notifications::components.actions',
		'filament-notifications::components.body',
		'filament-notifications::components.close-button',
		'filament-notifications::components.database.echo',
		'filament-notifications::components.database.modal.actions',
		'filament-notifications::components.database.modal.heading',
		'filament-notifications::components.database.modal.index',
		'filament-notifications::components.database.trigger',
		'filament-notifications::components.date',
		'filament-notifications::components.echo',
		'filament-notifications::components.icon',
		'filament-notifications::components.notification',
		'filament-notifications::components.title',
		'filament-notifications::database-notifications',
		'filament-notifications::notification',
		'filament-notifications::notifications',
		'filament-panels::components.avatar.tenant',
		'filament-panels::components.avatar.user',
		'filament-panels::components.form.actions',
		'filament-panels::components.form.index',
		'filament-panels::components.global-search.actions',
		'filament-panels::components.global-search.field',
		'filament-panels::components.global-search.index',
		'filament-panels::components.global-search.no-results-message',
		'filament-panels::components.global-search.result',
		'filament-panels::components.global-search.result-group',
		'filament-panels::components.global-search.results-container',
		'filament-panels::components.header.index',
		'filament-panels::components.header.simple',
		...
		'filament-panels::components.page.index',
		'filament-panels::components.page.simple',
		'filament-panels::components.page.sub-navigation.select',
		'filament-panels::components.page.sub-navigation.sidebar',
		'filament-panels::components.page.sub-navigation.tabs',
		'filament-panels::components.page.unsaved-data-changes-alert',
		'filament-panels::components.resources.relation-managers',
		'filament-panels::components.resources.tabs',
		'filament-panels::components.sidebar.group',
		'filament-panels::components.sidebar.index',
		'filament-panels::components.sidebar.item',
		'filament-panels::components.tenant-menu',
		'filament-panels::components.theme-switcher.button',
		'filament-panels::components.theme-switcher.index',
		'filament-panels::components.topbar.database-notifications-trigger',
		'filament-panels::components.topbar.index',
		'filament-panels::components.topbar.item',
		'filament-panels::components.unsaved-action-changes-alert',
		'filament-panels::components.user-menu',
		'filament-panels::pages.auth.edit-profile',
		'filament-panels::pages.auth.email-verification.email-verification-prompt',
		'filament-panels::pages.auth.login',
		'filament-panels::pages.auth.password-reset.request-password-reset',
		'filament-panels::pages.auth.password-reset.reset-password',
		'filament-panels::pages.auth.register',
		'filament-panels::pages.dashboard',
		'filament-panels::pages.tenancy.edit-tenant-profile',
		'filament-panels::pages.tenancy.register-tenant',
		'filament-panels::resources.pages.create-record',
		'filament-panels::resources.pages.edit-record',
		'filament-panels::resources.pages.list-records',
		'filament-panels::resources.pages.manage-related-records',
		'filament-panels::resources.pages.view-record',
		'filament-panels::resources.relation-manager',
		'filament-panels::widgets.account-widget',
		'filament-panels::widgets.filament-info-widget',
		'filament-spatie-laravel-settings-plugin::pages.settings-page',
		'filament-tables::columns.checkbox-column',
		'filament-tables::columns.color-column',
		'filament-tables::columns.icon-column',
		'filament-tables::columns.image-column',
		'filament-tables::columns.layout.grid',
		'filament-tables::columns.layout.panel',
		'filament-tables::columns.layout.split',
		'filament-tables::columns.layout.stack',
		'filament-tables::columns.select-column',
		'filament-tables::columns.summaries.icon-count',
		'filament-tables::columns.summaries.range',
		'filament-tables::columns.summaries.text',
		'filament-tables::columns.summaries.values',
		'filament-tables::columns.text-column',
		'filament-tables::columns.text-input-column',
		'filament-tables::columns.toggle-column',
		'filament-tables::components.actions',
		'filament-tables::components.actions.cell',
		'filament-tables::components.cell',
		'filament-tables::components.column-toggle.dropdown',
		'filament-tables::components.columns.column',
		'filament-tables::components.columns.layout',
		'filament-tables::components.columns.placeholder',
		'filament-tables::components.container',
		'filament-tables::components.empty-state.description',
		'filament-tables::components.empty-state.heading',
		'filament-tables::components.empty-state.index',
		'filament-tables::components.filters.dialog',
		'filament-tables::components.filters.index',
		'filament-tables::components.filters.indicators',
		'filament-tables::components.group.header',
		'filament-tables::components.groups',
		'filament-tables::components.header',
		'filament-tables::components.header-cell',
		'filament-tables::components.reorder.cell',
		'filament-tables::components.reorder.handle',
		'filament-tables::components.reorder.indicator',
		'filament-tables::components.row',
		'filament-tables::components.search-field',
		'filament-tables::components.selection.cell',
		'filament-tables::components.selection.checkbox',
		'filament-tables::components.selection.group-cell',
		'filament-tables::components.selection.group-checkbox',
		'filament-tables::components.selection.indicator',
		'filament-tables::components.summary.header-cell',
		'filament-tables::components.summary.index',
		'filament-tables::components.summary.row',
		'filament-tables::components.table',
		'filament-tables::index',
		'filament-widgets::chart-widget',
		'filament-widgets::components.widget',
		'filament-widgets::components.widgets',
		'filament-widgets::stats-overview-widget',
		'filament-widgets::stats-overview-widget.stat',
		'filament-widgets::table-widget',
		'filament::assets',
		'filament::components.actions',
		'filament::components.avatar',
		'filament::components.badge',
		'filament::components.breadcrumbs',
		'filament::components.button.group',
		'filament::components.button.index',
		'filament::components.card',
		'filament::components.dropdown.header',
		'filament::components.dropdown.index',
		'filament::components.dropdown.list.index',
		'filament::components.dropdown.list.item',
		'filament::components.fieldset',
		'filament::components.grid.column',
		'filament::components.grid.index',
		'filament::components.icon',
		'filament::components.icon-button',
		'filament::components.input.checkbox',
		'filament::components.input.index',
		'filament::components.input.radio',
		'filament::components.input.select',
		'filament::components.input.wrapper',
		'filament::components.link',
		'filament::components.loading-indicator',
		'filament::components.loading-section',
		'filament::components.modal.description',
		'filament::components.modal.heading',
		'filament::components.modal.index',
		'filament::components.pagination.index',
		'filament::components.pagination.item',
		'filament::components.section.description',
		'filament::components.section.heading',
		'filament::components.section.index',
		'filament::components.tabs.index',
	...
	registerArgumentsSet(
		...
		'filament-actions::associate.single.label',
		'filament-actions::associate.single.modal.heading',
		'filament-actions::associate.single.modal.fields.record_id.label',
		'filament-actions::associate.single.modal.actions.associate.label',
		'filament-actions::associate.single.modal.actions.associate_another.label',
		'filament-actions::associate.single.notifications.associated.title',
		'filament-actions::attach.single.label',
		'filament-actions::attach.single.modal.heading',
		'filament-actions::attach.single.modal.fields.record_id.label',
		'filament-actions::attach.single.modal.actions.attach.label',
		'filament-actions::attach.single.modal.actions.attach_another.label',
		'filament-actions::attach.single.notifications.attached.title',
		'filament-actions::create.single.label',
		'filament-actions::create.single.modal.heading',
		'filament-actions::create.single.modal.actions.create.label',
		'filament-actions::create.single.modal.actions.create_another.label',
		'filament-actions::create.single.notifications.created.title',
		...
		'filament-actions::delete.multiple.label',
		'filament-actions::delete.multiple.modal.heading',
		'filament-actions::delete.multiple.modal.actions.delete.label',
		'filament-actions::delete.multiple.notifications.deleted.title',
		'filament-actions::detach.single.label',
		'filament-actions::detach.single.modal.heading',
		'filament-actions::detach.single.modal.actions.detach.label',
		'filament-actions::detach.single.notifications.detached.title',
		'filament-actions::detach.multiple.label',
		'filament-actions::detach.multiple.modal.heading',
		'filament-actions::detach.multiple.modal.actions.detach.label',
		'filament-actions::detach.multiple.notifications.detached.title',
		'filament-actions::dissociate.single.label',
		'filament-actions::dissociate.single.modal.heading',
		'filament-actions::dissociate.single.modal.actions.dissociate.label',
		'filament-actions::dissociate.single.notifications.dissociated.title',
		'filament-actions::dissociate.multiple.label',
		'filament-actions::dissociate.multiple.modal.heading',
		'filament-actions::dissociate.multiple.modal.actions.dissociate.label',
		'filament-actions::dissociate.multiple.notifications.dissociated.title',
		'filament-actions::edit.single.label',
		'filament-actions::edit.single.modal.heading',
		'filament-actions::edit.single.modal.actions.save.label',
		'filament-actions::edit.single.notifications.saved.title',
		'filament-actions::export.label',
		'filament-actions::export.modal.heading',
		'filament-actions::export.modal.form.columns.label',
		'filament-actions::export.modal.form.columns.form.is_enabled.label',
		'filament-actions::export.modal.form.columns.form.label.label',
		'filament-actions::export.modal.actions.export.label',
		'filament-actions::export.notifications.completed.title',
		'filament-actions::export.notifications.completed.actions.download_csv.label',
		'filament-actions::export.notifications.completed.actions.download_xlsx.label',
		'filament-actions::export.notifications.max_rows.title',
		'filament-actions::export.notifications.max_rows.body',
		'filament-actions::export.notifications.started.title',
		'filament-actions::export.notifications.started.body',
		'filament-actions::export.file_name',
		'filament-actions::force-delete.single.label',
		'filament-actions::force-delete.single.modal.heading',
		'filament-actions::force-delete.single.modal.actions.delete.label',
		'filament-actions::force-delete.single.notifications.deleted.title',
		'filament-actions::force-delete.multiple.label',
		'filament-actions::force-delete.multiple.modal.heading',
		'filament-actions::force-delete.multiple.modal.actions.delete.label',
		'filament-actions::force-delete.multiple.notifications.deleted.title',
		'filament-actions::group.trigger.label',
		'filament-actions::import.label',
		'filament-actions::import.modal.heading',
		'filament-actions::import.modal.form.file.label',
		'filament-actions::import.modal.form.file.placeholder',
		'filament-actions::import.modal.form.file.rules.duplicate_columns',
		'filament-actions::import.modal.form.columns.label',
		'filament-actions::import.modal.form.columns.placeholder',
		'filament-actions::import.modal.actions.download_example.label',
		'filament-actions::import.modal.actions.import.label',
		'filament-actions::import.notifications.completed.title',
		'filament-actions::import.notifications.completed.actions.download_failed_rows_csv.label',
		'filament-actions::import.notifications.max_rows.title',
		'filament-actions::import.notifications.max_rows.body',
		'filament-actions::import.notifications.started.title',
		'filament-actions::import.notifications.started.body',
		'filament-actions::import.example_csv.file_name',
		'filament-actions::import.failure_csv.file_name',
		'filament-actions::import.failure_csv.error_header',
		'filament-actions::import.failure_csv.system_error',
		'filament-actions::import.failure_csv.column_mapping_required_for_new_record',
		'filament-actions::modal.confirmation',
		'filament-actions::modal.actions.cancel.label',
		'filament-actions::modal.actions.confirm.label',
		'filament-actions::modal.actions.submit.label',
		'filament-actions::replicate.single.label',
		'filament-actions::replicate.single.modal.heading',
		'filament-actions::replicate.single.modal.actions.replicate.label',
		'filament-actions::replicate.single.notifications.replicated.title',
		'filament-actions::restore.single.label',
		'filament-actions::restore.single.modal.heading',
		'filament-actions::restore.single.modal.actions.restore.label',
		'filament-actions::restore.single.notifications.restored.title',
		'filament-actions::restore.multiple.label',
		'filament-actions::restore.multiple.modal.heading',
		'filament-actions::restore.multiple.modal.actions.restore.label',
		'filament-actions::restore.multiple.notifications.restored.title',
		'filament-actions::view.single.label',
		'filament-actions::view.single.modal.heading',
		'filament-actions::view.single.modal.actions.close.label',
		'filament-actions::global-search.0',
		'filament-actions::layout.0',
		'filament-actions::edit-profile.0',
		'filament-actions::email-verification-prompt.0',
		'filament-actions::login.0',
		'filament-actions::request-password-reset.0',
		'filament-actions::reset-password.0',
		'filament-actions::register.0',
		'filament-actions::dashboard.0',
		'filament-actions::edit-tenant-profile.0',
		'filament-actions::create-record.0',
		'filament-actions::edit-record.0',
		'filament-actions::list-records.0',
		'filament-actions::view-record.0',
		'filament-actions::account-widget.0',
		'filament-actions::filament-info-widget.0',
		'filament-panels::global-search.field.label',
		'filament-panels::global-search.field.placeholder',
		'filament-panels::global-search.no_results_message',
		'filament-panels::layout.direction',
		'filament-panels::layout.actions.billing.label',
		'filament-panels::layout.actions.logout.label',
		'filament-panels::layout.actions.open_database_notifications.label',
		'filament-panels::layout.actions.open_user_menu.label',
		'filament-panels::layout.actions.sidebar.collapse.label',
		'filament-panels::layout.actions.sidebar.expand.label',
		'filament-panels::layout.actions.theme_switcher.dark.label',
		'filament-panels::layout.actions.theme_switcher.light.label',
		'filament-panels::layout.actions.theme_switcher.system.label',
		'filament-panels::layout.avatar.alt',
		'filament-panels::layout.logo.alt',
		'filament-panels::edit-profile.0',
		'filament-panels::email-verification-prompt.0',
		'filament-panels::login.0',
		'filament-panels::request-password-reset.0',
		'filament-panels::reset-password.0',
		'filament-panels::register.0',
		'filament-panels::dashboard.0',
		'filament-panels::edit-tenant-profile.0',
		'filament-panels::create-record.0',
		'filament-panels::edit-record.0',
		'filament-panels::list-records.0',
		'filament-panels::view-record.0',
		'filament-panels::unsaved-changes-alert.body',
		'filament-panels::account-widget.0',
		'filament-panels::filament-info-widget.0',
		'filament-forms::components.builder.actions.clone.label',
		'filament-forms::components.builder.actions.add.label',
		'filament-forms::components.builder.actions.add.modal.heading',
		'filament-forms::components.builder.actions.add.modal.actions.add.label',
		'filament-forms::components.builder.actions.add_between.label',
		'filament-forms::components.builder.actions.add_between.modal.heading',
		'filament-forms::components.builder.actions.add_between.modal.actions.add.label',
		'filament-forms::components.builder.actions.delete.label',
		'filament-forms::components.builder.actions.edit.label',
		'filament-forms::components.builder.actions.edit.modal.heading',
		'filament-forms::components.builder.actions.edit.modal.actions.save.label',
		'filament-forms::components.builder.actions.reorder.label',
		'filament-forms::components.builder.actions.move_down.label',
		'filament-forms::components.builder.actions.move_up.label',
		'filament-forms::components.builder.actions.collapse.label',
		'filament-forms::components.builder.actions.expand.label',
		...
		'filament-forms::components.file_upload.editor.actions.cancel.label',
		'filament-forms::components.file_upload.editor.actions.drag_crop.label',
		'filament-forms::components.file_upload.editor.actions.drag_move.label',
		'filament-forms::components.file_upload.editor.actions.flip_horizontal.label',
		'filament-forms::components.file_upload.editor.actions.flip_vertical.label',
		'filament-forms::components.file_upload.editor.actions.move_down.label',
		'filament-forms::components.file_upload.editor.actions.move_left.label',
		'filament-forms::components.file_upload.editor.actions.move_right.label',
		'filament-forms::components.file_upload.editor.actions.move_up.label',
		...
		'filament-forms::components.file_upload.editor.actions.rotate_right.label',
		'filament-forms::components.file_upload.editor.actions.set_aspect_ratio.label',
		'filament-forms::components.file_upload.editor.actions.save.label',
		'filament-forms::components.file_upload.editor.actions.zoom_100.label',
		'filament-forms::components.file_upload.editor.actions.zoom_in.label',
		'filament-forms::components.file_upload.editor.actions.zoom_out.label',
		'filament-forms::components.file_upload.editor.fields.height.label',
		'filament-forms::components.file_upload.editor.fields.height.unit',
		'filament-forms::components.file_upload.editor.fields.rotation.label',
		'filament-forms::components.file_upload.editor.fields.rotation.unit',
		'filament-forms::components.file_upload.editor.fields.width.label',
		...
		'filament-forms::components.file_upload.editor.aspect_ratios.label',
		'filament-forms::components.file_upload.editor.aspect_ratios.no_fixed.label',
		'filament-forms::components.file_upload.editor.svg.messages.confirmation',
		'filament-forms::components.file_upload.editor.svg.messages.disabled',
		'filament-forms::components.key_value.actions.add.label',
		'filament-forms::components.key_value.actions.delete.label',
		'filament-forms::components.key_value.actions.reorder.label',
		'filament-forms::components.key_value.fields.key.label',
		'filament-forms::components.key_value.fields.value.label',
		'filament-forms::components.markdown_editor.toolbar_buttons.attach_files',
		'filament-forms::components.markdown_editor.toolbar_buttons.blockquote',
		'filament-forms::components.markdown_editor.toolbar_buttons.bold',
		'filament-forms::components.markdown_editor.toolbar_buttons.bullet_list',
		'filament-forms::components.markdown_editor.toolbar_buttons.code_block',
		'filament-forms::components.markdown_editor.toolbar_buttons.heading',
		'filament-forms::components.markdown_editor.toolbar_buttons.italic',
		'filament-forms::components.markdown_editor.toolbar_buttons.link',
		'filament-forms::components.markdown_editor.toolbar_buttons.ordered_list',
		'filament-forms::components.markdown_editor.toolbar_buttons.redo',
		'filament-forms::components.markdown_editor.toolbar_buttons.strike',
		'filament-forms::components.markdown_editor.toolbar_buttons.table',
		'filament-forms::components.markdown_editor.toolbar_buttons.undo',
		'filament-forms::components.radio.boolean.true',
		'filament-forms::components.radio.boolean.false',
		'filament-forms::components.repeater.actions.add.label',
		'filament-forms::components.repeater.actions.add_between.label',
		'filament-forms::components.repeater.actions.delete.label',
		'filament-forms::components.repeater.actions.clone.label',
		'filament-forms::components.repeater.actions.reorder.label',
		'filament-forms::components.repeater.actions.move_down.label',
		'filament-forms::components.repeater.actions.move_up.label',
		'filament-forms::components.repeater.actions.collapse.label',
		'filament-forms::components.repeater.actions.expand.label',
		'filament-forms::components.repeater.actions.collapse_all.label',
		'filament-forms::components.repeater.actions.expand_all.label',
		'filament-forms::components.rich_editor.dialogs.link.actions.link',
		'filament-forms::components.rich_editor.dialogs.link.actions.unlink',
		'filament-forms::components.rich_editor.dialogs.link.label',
		'filament-forms::components.rich_editor.dialogs.link.placeholder',
		'filament-forms::components.rich_editor.toolbar_buttons.attach_files',
		'filament-forms::components.rich_editor.toolbar_buttons.blockquote',
		'filament-forms::components.rich_editor.toolbar_buttons.bold',
		'filament-forms::components.rich_editor.toolbar_buttons.bullet_list',
		'filament-forms::components.rich_editor.toolbar_buttons.code_block',
		'filament-forms::components.rich_editor.toolbar_buttons.h1',
		'filament-forms::components.rich_editor.toolbar_buttons.h2',
		'filament-forms::components.rich_editor.toolbar_buttons.h3',
		'filament-forms::components.rich_editor.toolbar_buttons.italic',
		'filament-forms::components.rich_editor.toolbar_buttons.link',
		'filament-forms::components.rich_editor.toolbar_buttons.ordered_list',
		'filament-forms::components.rich_editor.toolbar_buttons.redo',
		...
		'filament-forms::components.select.actions.create_option.label',
		'filament-forms::components.select.actions.create_option.modal.heading',
		'filament-forms::components.select.actions.create_option.modal.actions.create.label',
		'filament-forms::components.select.actions.create_option.modal.actions.create_another.label',
		'filament-forms::components.select.actions.edit_option.label',
		'filament-forms::components.select.actions.edit_option.modal.heading',
		'filament-forms::components.select.actions.edit_option.modal.actions.save.label',
		'filament-forms::components.select.boolean.true',
		'filament-forms::components.select.boolean.false',
		'filament-forms::components.select.loading_message',
		'filament-forms::components.select.max_items_message',
		'filament-forms::components.select.no_search_results_message',
		'filament-forms::components.select.placeholder',
		'filament-forms::components.select.searching_message',
		'filament-forms::components.select.search_prompt',
		'filament-forms::components.tags_input.placeholder',
		'filament-forms::components.text_input.actions.hide_password.label',
		'filament-forms::components.text_input.actions.show_password.label',
		'filament-forms::components.toggle_buttons.boolean.true',
		'filament-forms::components.toggle_buttons.boolean.false',
		'filament-forms::components.wizard.actions.previous_step.label',
		'filament-forms::components.wizard.actions.next_step.label',
		'filament-forms::validation.distinct.must_be_selected',
		'filament-forms::validation.distinct.only_one_must_be_selected',
		'filament-infolists::components.entries.text.actions.collapse_list',
		'filament-infolists::components.entries.text.actions.expand_list',
		'filament-infolists::components.entries.text.more_list_items',
		'filament-infolists::components.entries.key_value.columns.key.label',
		'filament-infolists::components.entries.key_value.columns.value.label',
		'filament-infolists::components.entries.key_value.placeholder',
		'filament-notifications::database.modal.heading',
		'filament-notifications::database.modal.actions.clear.label',
		'filament-notifications::database.modal.actions.mark_all_as_read.label',
		'filament-notifications::database.modal.empty.heading',
		'filament-notifications::database.modal.empty.description',
		'filament-spatie-laravel-settings-plugin::settings-page.0',
		'filament::button.0',
		'filament::copyable.0',
		'filament::modal.0',
		'filament::pagination.0',
		'filament-tables::query-builder.0',
		'filament-tables::table.column_toggle.heading',
		'filament-tables::table.columns.actions.label',
		'filament-tables::table.columns.text.actions.collapse_list',
		'filament-tables::table.columns.text.actions.expand_list',
		'filament-tables::table.columns.text.more_list_items',
		'filament-tables::table.fields.bulk_select_page.label',
		'filament-tables::table.fields.bulk_select_record.label',
		'filament-tables::table.fields.bulk_select_group.label',
		'filament-tables::table.fields.search.label',
		'filament-tables::table.fields.search.placeholder',
		'filament-tables::table.fields.search.indicator',
		'filament-tables::table.summary.heading',
		'filament-tables::table.summary.subheadings.all',
		'filament-tables::table.summary.subheadings.group',
		'filament-tables::table.summary.subheadings.page',
		'filament-tables::table.summary.summarizers.average.label',
		'filament-tables::table.summary.summarizers.count.label',
		'filament-tables::table.summary.summarizers.sum.label',
		'filament-tables::table.actions.disable_reordering.label',
		'filament-tables::table.actions.enable_reordering.label',
		'filament-tables::table.actions.filter.label',
		'filament-tables::table.actions.group.label',
		'filament-tables::table.actions.open_bulk_actions.label',
		'filament-tables::table.actions.toggle_columns.label',
		'filament-tables::table.empty.heading',
		'filament-tables::table.empty.description',
		'filament-tables::table.filters.actions.apply.label',
		'filament-tables::table.filters.actions.remove.label',
		'filament-tables::table.filters.actions.remove_all.label',
		'filament-tables::table.filters.actions.remove_all.tooltip',
		'filament-tables::table.filters.actions.reset.label',
		'filament-tables::table.filters.heading',
		'filament-tables::table.filters.indicator',
		'filament-tables::table.filters.multi_select.placeholder',
		'filament-tables::table.filters.select.placeholder',
		'filament-tables::table.filters.trashed.label',
		'filament-tables::table.filters.trashed.only_trashed',
		'filament-tables::table.filters.trashed.with_trashed',
		'filament-tables::table.filters.trashed.without_trashed',
		'filament-tables::table.grouping.fields.group.label',
		'filament-tables::table.grouping.fields.group.placeholder',
		'filament-tables::table.grouping.fields.direction.label',
		'filament-tables::table.grouping.fields.direction.options.asc',
		'filament-tables::table.grouping.fields.direction.options.desc',
		'filament-tables::table.reorder_indicator',
		'filament-tables::table.selection_indicator.selected_count',
		'filament-tables::table.selection_indicator.actions.select_all.label',
		'filament-tables::table.selection_indicator.actions.deselect_all.label',
		'filament-tables::table.sorting.fields.column.label',
		'filament-tables::table.sorting.fields.direction.label',
		'filament-tables::table.sorting.fields.direction.options.asc',
