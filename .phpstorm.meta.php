...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.google.analytics_api_key' => 'NULL',
...
'auth.password_timeout','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes',
'blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled',
'blade-icons.components.default','blade-ui-kit.components.alert','blade-ui-kit.components.avatar','blade-ui-kit.components.carbon','blade-ui-kit.components.checkbox',
'blade-ui-kit.components.color-picker','blade-ui-kit.components.countdown','blade-ui-kit.components.cron','blade-ui-kit.components.dropdown','blade-ui-kit.components.easy-mde',
'blade-ui-kit.components.email','blade-ui-kit.components.error','blade-ui-kit.components.flat-pickr','blade-ui-kit.components.form','blade-ui-kit.components.form-button',
'blade-ui-kit.components.html','blade-ui-kit.components.input','blade-ui-kit.components.label','blade-ui-kit.components.logout','blade-ui-kit.components.mapbox',
'blade-ui-kit.components.markdown','blade-ui-kit.components.password','blade-ui-kit.components.pikaday','blade-ui-kit.components.social-meta','blade-ui-kit.components.textarea',
'blade-ui-kit.components.toc','blade-ui-kit.components.trix','blade-ui-kit.components.unsplash','blade-ui-kit.livewire','blade-ui-kit.prefix',
'blade-ui-kit.assets.alpine','blade-ui-kit.assets.easy-mde','blade-ui-kit.assets.flat-pickr','blade-ui-kit.assets.mapbox','blade-ui-kit.assets.moment',
'blade-ui-kit.assets.pickr','blade-ui-kit.assets.pikaday','blade-ui-kit.assets.trix','cache.default','cache.stores.array.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.blog.driver','filesystems.disks.blog.root','filesystems.disks.blog.url','filesystems.disks.blog.visibility',
'filesystems.disks.blog.throw','filesystems.links./Users/lele/Code/dm.site/public/storage','horizon.domain','horizon.path','horizon.use',
...
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.google.analytics_api_key',
'services.google.analytics_property_id','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'filament.admin.pages.dashboard','filament.admin.pages.settings.general','filament.admin.pages.settings.seo','filament.admin.resources.blog-categories.index','filament.admin.resources.blog-categories.create',
'filament.admin.resources.blog-categories.edit','filament.admin.resources.blog-posts.index','filament.admin.resources.blog-posts.create','filament.admin.resources.blog-posts.edit','filament.admin.resources.pages.index',
'filament.admin.resources.pages.create','filament.admin.resources.pages.edit','horizon.stats.index','horizon.workload.index','horizon.masters.index',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','livewire.update','livewire.upload-file','livewire.preview-file','log-viewer.hosts',
...
'pages.home','blog.index','blog.show','pages.page','storage.local',);
        registerArgumentsSet('views', 
'blog.index','blog.show','components.layouts.app','components.layouts.footer','components.layouts.header',
'filament.widgets.google-analytics-visitors-widget','pages.home','pages.home.about','pages.home.blog','pages.home.features',
'pages.page','pagination::default','pagination::simple-default','vendor.pagination.default','vendor.pagination.simple-default',
'blade-ui-kit::components.alerts.alert','blade-ui-kit::components.buttons.form-button','blade-ui-kit::components.buttons.logout','blade-ui-kit::components.date-time.carbon','blade-ui-kit::components.date-time.countdown',
'blade-ui-kit::components.editors.easy-mde','blade-ui-kit::components.editors.trix','blade-ui-kit::components.forms.error','blade-ui-kit::components.forms.form','blade-ui-kit::components.forms.inputs.checkbox',
'blade-ui-kit::components.forms.inputs.color-picker','blade-ui-kit::components.forms.inputs.email','blade-ui-kit::components.forms.inputs.flat-pickr','blade-ui-kit::components.forms.inputs.input','blade-ui-kit::components.forms.inputs.password',
'blade-ui-kit::components.forms.inputs.pikaday','blade-ui-kit::components.forms.inputs.textarea','blade-ui-kit::components.forms.label','blade-ui-kit::components.layouts.html','blade-ui-kit::components.layouts.social-meta',
'blade-ui-kit::components.maps.mapbox','blade-ui-kit::components.markdown.markdown','blade-ui-kit::components.markdown.toc','blade-ui-kit::components.navigation.dropdown','blade-ui-kit::components.support.avatar',
'blade-ui-kit::components.support.cron','blade-ui-kit::components.support.unsplash','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament::components.tabs.index','filament::components.tabs.item','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'VITE_APP_NAME','GOOGLE_ANALYTICS_PROPERTY_ID','GOOGLE_ANALYTICS_SERVICE_ACCOUNT_CREDENTIALS_JSON',);
