<footer class="bg-gray-100">
    <div class="mx-auto max-w-full pb-8 pt-8 sm:pt-12 lg:pt-16">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8 mx-6 lg:mx-8 px-6 lg:px-8">
        ...
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between  px-6 lg:px-8">
            <div>
        ...
        <div class="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between  px-6 lg:px-8">
            <div class="flex gap-x-6 md:order-2">
                <a href="{{config('site.social.x')}}" target="_blank" class="text-gray-600 hover:text-gray-800">
                    <span class="sr-only">X</span>
                    <svg class="size-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M13.6823 10.6218L20.2391 3H18.6854L12.9921 9.61788L8.44486 3H3.2002L10.0765 13.0074L3.2002 21H4.75404L10.7663 14.0113L15.5685 21H20.8131L13.6819 10.6218H13.6823ZM11.5541 13.0956L10.8574 12.0991L5.31391 4.16971H7.70053L12.1742 10.5689L12.8709 11.5655L18.6861 19.8835H16.2995L11.5541 13.096V13.0956Z"/>
                    </svg>
                </a>
                <a href="{{config('site.social.github')}}" target="_blank" class="text-gray-600 hover:text-gray-800">
                ...
                <a href="{{config('site.social.linkedin')}}" target="_blank" class="text-gray-600 hover:text-gray-800">
